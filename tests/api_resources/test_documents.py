...
from structify._response import BinaryAPIResponse, StreamedBinaryAPIResponse, AsyncBinaryAPIResponse, AsyncStreamedBinaryAPIResponse
...
from structify.types import document_delete_params
from structify.types import document_upload_params
...
class TestDocuments:
    ...
    def test_method_download(self, client: Structify, respx_mock: MockRouter) -> None:
        respx_mock.get('/documents/download').mock(
