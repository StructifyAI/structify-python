...
class TestTeams:
    ...
    def test_method_create_project(self, client: Structify) -> None:
        ...
        assert_matches_type(Project, team, path=["response"])
    ...
    @parametrize
    def test_method_get_subscription(self, client: Structify) -> None:
        team = client.teams.get_subscription(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(TeamSubscriptionStatus, team, path=["response"])

    @parametrize
    def test_raw_response_get_subscription(self, client: Structify) -> None:
        response = client.teams.with_raw_response.get_subscription(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    @parametrize
    def test_streaming_response_get_subscription(self, client: Structify) -> None:
        with client.teams.with_streaming_response.get_subscription(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @parametrize
    def test_path_params_get_subscription(self, client: Structify) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `team_id` but received ''"):
            client.teams.with_raw_response.get_subscription(
                "",
            )
    ...
    @parametrize
    def test_method_select(self, client: Structify) -> None:
        team = client.teams.select(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(SelectTeamResponse, team, path=["response"])

    @parametrize
    def test_raw_response_select(self, client: Structify) -> None:
        response = client.teams.with_raw_response.select(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    @parametrize
    def test_streaming_response_select(self, client: Structify) -> None:
        with client.teams.with_streaming_response.select(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @parametrize
    def test_path_params_select(self, client: Structify) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `team_id` but received ''"):
            client.teams.with_raw_response.select(
                "",
            )

    @parametrize
    def test_method_update_member_role(self, client: Structify) -> None:
        team = client.teams.update_member_role(
            user_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            team_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            role="read_only",
        )
        assert_matches_type(UpdateMemberRoleResponse, team, path=["response"])

    @parametrize
    def test_raw_response_update_member_role(self, client: Structify) -> None:
        response = client.teams.with_raw_response.update_member_role(
            user_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            team_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            role="read_only",
        )
    ...
    @parametrize
    def test_streaming_response_update_member_role(self, client: Structify) -> None:
        with client.teams.with_streaming_response.update_member_role(
            user_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            team_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            role="read_only",
        ) as response:
    ...
    @parametrize
    def test_path_params_update_member_role(self, client: Structify) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `team_id` but received ''"):
            client.teams.with_raw_response.update_member_role(
                user_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
                team_id="",
                role="read_only",
            )
...
class TestAsyncTeams:
    ...
    @parametrize
    async def test_method_get_subscription(self, async_client: AsyncStructify) -> None:
        team = await async_client.teams.get_subscription(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(TeamSubscriptionStatus, team, path=["response"])

    @parametrize
    async def test_raw_response_get_subscription(self, async_client: AsyncStructify) -> None:
        response = await async_client.teams.with_raw_response.get_subscription(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    @parametrize
    async def test_streaming_response_get_subscription(self, async_client: AsyncStructify) -> None:
        async with async_client.teams.with_streaming_response.get_subscription(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @parametrize
    async def test_path_params_get_subscription(self, async_client: AsyncStructify) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `team_id` but received ''"):
            await async_client.teams.with_raw_response.get_subscription(
                "",
            )
    ...
    @parametrize
    async def test_method_select(self, async_client: AsyncStructify) -> None:
        team = await async_client.teams.select(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(SelectTeamResponse, team, path=["response"])

    @parametrize
    async def test_raw_response_select(self, async_client: AsyncStructify) -> None:
        response = await async_client.teams.with_raw_response.select(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    @parametrize
    async def test_streaming_response_select(self, async_client: AsyncStructify) -> None:
        async with async_client.teams.with_streaming_response.select(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @parametrize
    async def test_path_params_select(self, async_client: AsyncStructify) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `team_id` but received ''"):
            await async_client.teams.with_raw_response.select(
                "",
            )

    @parametrize
    async def test_method_update_member_role(self, async_client: AsyncStructify) -> None:
        team = await async_client.teams.update_member_role(
            user_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            team_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            role="read_only",
        )
    ...
    @parametrize
    async def test_raw_response_update_member_role(self, async_client: AsyncStructify) -> None:
        response = await async_client.teams.with_raw_response.update_member_role(
            user_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            team_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            role="read_only",
        )
    ...
    @parametrize
    async def test_streaming_response_update_member_role(self, async_client: AsyncStructify) -> None:
        async with async_client.teams.with_streaming_response.update_member_role(
            user_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            team_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            role="read_only",
        ) as response:
    ...
    @parametrize
    async def test_path_params_update_member_role(self, async_client: AsyncStructify) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `team_id` but received ''"):
            await async_client.teams.with_raw_response.update_member_role(
                user_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
                team_id="",
                role="read_only",
            )
