...
class TestSearchapi:
    ...
    def test_method_google_flights_calendar(self, client: Structify) -> None:
        searchapi = client.external.searchapi.google_flights_calendar(
            arrival_id="arrival_id",
            departure_id="departure_id",
            outbound_date="outbound_date",
        )
        assert_matches_type(SearchapiGoogleFlightsCalendarResponse, searchapi, path=["response"])
    ...
    def test_raw_response_google_flights_calendar(self, client: Structify) -> None:
        response = client.external.searchapi.with_raw_response.google_flights_calendar(
            arrival_id="arrival_id",
            departure_id="departure_id",
            outbound_date="outbound_date",
        )
        ...
        searchapi = response.parse()
        assert_matches_type(SearchapiGoogleFlightsCalendarResponse, searchapi, path=["response"])

    @parametrize
    def test_streaming_response_google_flights_calendar(self, client: Structify) -> None:
        with client.external.searchapi.with_streaming_response.google_flights_calendar(
            arrival_id="arrival_id",
            departure_id="departure_id",
            outbound_date="outbound_date",
        ) as response:
    ...
    def test_method_google_flights_location_search(self, client: Structify) -> None:
        searchapi = client.external.searchapi.google_flights_location_search(
            q="q",
        )
        assert_matches_type(SearchapiGoogleFlightsLocationSearchResponse, searchapi, path=["response"])
    ...
    def test_raw_response_google_flights_location_search(self, client: Structify) -> None:
        response = client.external.searchapi.with_raw_response.google_flights_location_search(
            q="q",
        )
    ...
    def test_streaming_response_google_flights_location_search(self, client: Structify) -> None:
        with client.external.searchapi.with_streaming_response.google_flights_location_search(
            q="q",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_google_flights_search(self, client: Structify) -> None:
        searchapi = client.external.searchapi.google_flights_search(
            arrival_id="arrival_id",
            departure_id="departure_id",
            outbound_date="outbound_date",
        )
        assert_matches_type(SearchapiGoogleFlightsSearchResponse, searchapi, path=["response"])
    ...
    def test_raw_response_google_flights_search(self, client: Structify) -> None:
        response = client.external.searchapi.with_raw_response.google_flights_search(
            arrival_id="arrival_id",
            departure_id="departure_id",
            outbound_date="outbound_date",
        )
    ...
    def test_streaming_response_google_flights_search(self, client: Structify) -> None:
        with client.external.searchapi.with_streaming_response.google_flights_search(
            arrival_id="arrival_id",
            departure_id="departure_id",
            outbound_date="outbound_date",
        ) as response:
    ...
    def test_method_google_maps_place_details(self, client: Structify) -> None:
        searchapi = client.external.searchapi.google_maps_place_details(
            place_id="place_id",
        )
        assert_matches_type(SearchapiGoogleMapsPlaceDetailsResponse, searchapi, path=["response"])
    ...
    def test_raw_response_google_maps_place_details(self, client: Structify) -> None:
        response = client.external.searchapi.with_raw_response.google_maps_place_details(
            place_id="place_id",
        )
    ...
    def test_streaming_response_google_maps_place_details(self, client: Structify) -> None:
        with client.external.searchapi.with_streaming_response.google_maps_place_details(
            place_id="place_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_google_maps_place_photos(self, client: Structify) -> None:
        searchapi = client.external.searchapi.google_maps_place_photos(
            place_id="place_id",
        )
        assert_matches_type(SearchapiGoogleMapsPlacePhotosResponse, searchapi, path=["response"])
    ...
    def test_raw_response_google_maps_place_photos(self, client: Structify) -> None:
        response = client.external.searchapi.with_raw_response.google_maps_place_photos(
            place_id="place_id",
        )
    ...
    def test_streaming_response_google_maps_place_photos(self, client: Structify) -> None:
        with client.external.searchapi.with_streaming_response.google_maps_place_photos(
            place_id="place_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_google_maps_place_reviews(self, client: Structify) -> None:
        searchapi = client.external.searchapi.google_maps_place_reviews(
            place_id="place_id",
        )
        assert_matches_type(SearchapiGoogleMapsPlaceReviewsResponse, searchapi, path=["response"])
    ...
    def test_raw_response_google_maps_place_reviews(self, client: Structify) -> None:
        response = client.external.searchapi.with_raw_response.google_maps_place_reviews(
            place_id="place_id",
        )
    ...
    def test_streaming_response_google_maps_place_reviews(self, client: Structify) -> None:
        with client.external.searchapi.with_streaming_response.google_maps_place_reviews(
            place_id="place_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_google_maps_search(self, client: Structify) -> None:
        searchapi = client.external.searchapi.google_maps_search(
            q="q",
        )
        assert_matches_type(SearchapiGoogleMapsSearchResponse, searchapi, path=["response"])
    ...
    def test_raw_response_google_maps_search(self, client: Structify) -> None:
        response = client.external.searchapi.with_raw_response.google_maps_search(
            q="q",
        )
    ...
    def test_streaming_response_google_maps_search(self, client: Structify) -> None:
        with client.external.searchapi.with_streaming_response.google_maps_search(
            q="q",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_google_scholar_author_search(self, client: Structify) -> None:
        searchapi = client.external.searchapi.google_scholar_author_search(
            author="author",
        )
        assert_matches_type(SearchapiGoogleScholarAuthorSearchResponse, searchapi, path=["response"])
    ...
    def test_raw_response_google_scholar_author_search(self, client: Structify) -> None:
        response = client.external.searchapi.with_raw_response.google_scholar_author_search(
            author="author",
        )
    ...
    def test_streaming_response_google_scholar_author_search(self, client: Structify) -> None:
        with client.external.searchapi.with_streaming_response.google_scholar_author_search(
            author="author",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_google_scholar_citations(self, client: Structify) -> None:
        searchapi = client.external.searchapi.google_scholar_citations(
            q="q",
        )
        assert_matches_type(SearchapiGoogleScholarCitationsResponse, searchapi, path=["response"])
    ...
    def test_raw_response_google_scholar_citations(self, client: Structify) -> None:
        response = client.external.searchapi.with_raw_response.google_scholar_citations(
            q="q",
        )
    ...
    def test_streaming_response_google_scholar_citations(self, client: Structify) -> None:
        with client.external.searchapi.with_streaming_response.google_scholar_citations(
            q="q",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_google_scholar_search(self, client: Structify) -> None:
        searchapi = client.external.searchapi.google_scholar_search(
            q="q",
        )
        assert_matches_type(SearchapiGoogleScholarSearchResponse, searchapi, path=["response"])
    ...
    def test_raw_response_google_scholar_search(self, client: Structify) -> None:
        response = client.external.searchapi.with_raw_response.google_scholar_search(
            q="q",
        )
    ...
    def test_streaming_response_google_scholar_search(self, client: Structify) -> None:
        with client.external.searchapi.with_streaming_response.google_scholar_search(
            q="q",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_google_search(self, client: Structify) -> None:
        searchapi = client.external.searchapi.google_search(
            q="q",
        )
        assert_matches_type(GoogleSearchResponse, searchapi, path=["response"])
    ...
    def test_raw_response_google_search(self, client: Structify) -> None:
        response = client.external.searchapi.with_raw_response.google_search(
            q="q",
        )
    ...
    def test_streaming_response_google_search(self, client: Structify) -> None:
        with client.external.searchapi.with_streaming_response.google_search(
            q="q",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_location_search(self, client: Structify) -> None:
        searchapi = client.external.searchapi.location_search(
            q="q",
        )
        assert_matches_type(LocationResponse, searchapi, path=["response"])
    ...
    def test_raw_response_location_search(self, client: Structify) -> None:
        response = client.external.searchapi.with_raw_response.location_search(
            q="q",
        )
    ...
    def test_streaming_response_location_search(self, client: Structify) -> None:
        with client.external.searchapi.with_streaming_response.location_search(
            q="q",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncSearchapi:
    ...
    async def test_method_google_flights_calendar(self, async_client: AsyncStructify) -> None:
        searchapi = await async_client.external.searchapi.google_flights_calendar(
            arrival_id="arrival_id",
            departure_id="departure_id",
            outbound_date="outbound_date",
        )
    ...
    async def test_raw_response_google_flights_calendar(self, async_client: AsyncStructify) -> None:
        response = await async_client.external.searchapi.with_raw_response.google_flights_calendar(
            arrival_id="arrival_id",
            departure_id="departure_id",
            outbound_date="outbound_date",
        )
        ...
        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        searchapi = await response.parse()
        assert_matches_type(SearchapiGoogleFlightsCalendarResponse, searchapi, path=["response"])

    @parametrize
    async def test_streaming_response_google_flights_calendar(self, async_client: AsyncStructify) -> None:
        async with async_client.external.searchapi.with_streaming_response.google_flights_calendar(
            arrival_id="arrival_id",
            departure_id="departure_id",
            outbound_date="outbound_date",
        ) as response:
    ...
    async def test_method_google_flights_location_search(self, async_client: AsyncStructify) -> None:
        searchapi = await async_client.external.searchapi.google_flights_location_search(
            q="q",
        )
        assert_matches_type(SearchapiGoogleFlightsLocationSearchResponse, searchapi, path=["response"])
    ...
    async def test_raw_response_google_flights_location_search(self, async_client: AsyncStructify) -> None:
        response = await async_client.external.searchapi.with_raw_response.google_flights_location_search(
            q="q",
        )
    ...
    async def test_streaming_response_google_flights_location_search(self, async_client: AsyncStructify) -> None:
        async with async_client.external.searchapi.with_streaming_response.google_flights_location_search(
            q="q",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_google_flights_search(self, async_client: AsyncStructify) -> None:
        searchapi = await async_client.external.searchapi.google_flights_search(
            arrival_id="arrival_id",
            departure_id="departure_id",
            outbound_date="outbound_date",
        )
    ...
    async def test_raw_response_google_flights_search(self, async_client: AsyncStructify) -> None:
        response = await async_client.external.searchapi.with_raw_response.google_flights_search(
            arrival_id="arrival_id",
            departure_id="departure_id",
            outbound_date="outbound_date",
        )
    ...
    async def test_streaming_response_google_flights_search(self, async_client: AsyncStructify) -> None:
        async with async_client.external.searchapi.with_streaming_response.google_flights_search(
            arrival_id="arrival_id",
            departure_id="departure_id",
            outbound_date="outbound_date",
        ) as response:
    ...
    async def test_method_google_maps_place_details(self, async_client: AsyncStructify) -> None:
        searchapi = await async_client.external.searchapi.google_maps_place_details(
            place_id="place_id",
        )
        assert_matches_type(SearchapiGoogleMapsPlaceDetailsResponse, searchapi, path=["response"])
    ...
    async def test_raw_response_google_maps_place_details(self, async_client: AsyncStructify) -> None:
        response = await async_client.external.searchapi.with_raw_response.google_maps_place_details(
            place_id="place_id",
        )
    ...
    async def test_streaming_response_google_maps_place_details(self, async_client: AsyncStructify) -> None:
        async with async_client.external.searchapi.with_streaming_response.google_maps_place_details(
            place_id="place_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_google_maps_place_photos(self, async_client: AsyncStructify) -> None:
        searchapi = await async_client.external.searchapi.google_maps_place_photos(
            place_id="place_id",
        )
        assert_matches_type(SearchapiGoogleMapsPlacePhotosResponse, searchapi, path=["response"])
    ...
    async def test_raw_response_google_maps_place_photos(self, async_client: AsyncStructify) -> None:
        response = await async_client.external.searchapi.with_raw_response.google_maps_place_photos(
            place_id="place_id",
        )
    ...
    async def test_streaming_response_google_maps_place_photos(self, async_client: AsyncStructify) -> None:
        async with async_client.external.searchapi.with_streaming_response.google_maps_place_photos(
            place_id="place_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_google_maps_place_reviews(self, async_client: AsyncStructify) -> None:
        searchapi = await async_client.external.searchapi.google_maps_place_reviews(
            place_id="place_id",
        )
        assert_matches_type(SearchapiGoogleMapsPlaceReviewsResponse, searchapi, path=["response"])
    ...
    async def test_raw_response_google_maps_place_reviews(self, async_client: AsyncStructify) -> None:
        response = await async_client.external.searchapi.with_raw_response.google_maps_place_reviews(
            place_id="place_id",
        )
    ...
    async def test_streaming_response_google_maps_place_reviews(self, async_client: AsyncStructify) -> None:
        async with async_client.external.searchapi.with_streaming_response.google_maps_place_reviews(
            place_id="place_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_google_maps_search(self, async_client: AsyncStructify) -> None:
        searchapi = await async_client.external.searchapi.google_maps_search(
            q="q",
        )
        assert_matches_type(SearchapiGoogleMapsSearchResponse, searchapi, path=["response"])
    ...
    async def test_raw_response_google_maps_search(self, async_client: AsyncStructify) -> None:
        response = await async_client.external.searchapi.with_raw_response.google_maps_search(
            q="q",
        )
    ...
    async def test_streaming_response_google_maps_search(self, async_client: AsyncStructify) -> None:
        async with async_client.external.searchapi.with_streaming_response.google_maps_search(
            q="q",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_google_scholar_author_search(self, async_client: AsyncStructify) -> None:
        searchapi = await async_client.external.searchapi.google_scholar_author_search(
            author="author",
        )
        assert_matches_type(SearchapiGoogleScholarAuthorSearchResponse, searchapi, path=["response"])
    ...
    async def test_raw_response_google_scholar_author_search(self, async_client: AsyncStructify) -> None:
        response = await async_client.external.searchapi.with_raw_response.google_scholar_author_search(
            author="author",
        )
    ...
    async def test_streaming_response_google_scholar_author_search(self, async_client: AsyncStructify) -> None:
        async with async_client.external.searchapi.with_streaming_response.google_scholar_author_search(
            author="author",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_google_scholar_citations(self, async_client: AsyncStructify) -> None:
        searchapi = await async_client.external.searchapi.google_scholar_citations(
            q="q",
        )
        assert_matches_type(SearchapiGoogleScholarCitationsResponse, searchapi, path=["response"])
    ...
    async def test_raw_response_google_scholar_citations(self, async_client: AsyncStructify) -> None:
        response = await async_client.external.searchapi.with_raw_response.google_scholar_citations(
            q="q",
        )
    ...
    async def test_streaming_response_google_scholar_citations(self, async_client: AsyncStructify) -> None:
        async with async_client.external.searchapi.with_streaming_response.google_scholar_citations(
            q="q",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_google_scholar_search(self, async_client: AsyncStructify) -> None:
        searchapi = await async_client.external.searchapi.google_scholar_search(
            q="q",
        )
        assert_matches_type(SearchapiGoogleScholarSearchResponse, searchapi, path=["response"])
    ...
    async def test_raw_response_google_scholar_search(self, async_client: AsyncStructify) -> None:
        response = await async_client.external.searchapi.with_raw_response.google_scholar_search(
            q="q",
        )
    ...
    async def test_streaming_response_google_scholar_search(self, async_client: AsyncStructify) -> None:
        async with async_client.external.searchapi.with_streaming_response.google_scholar_search(
            q="q",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_google_search(self, async_client: AsyncStructify) -> None:
        searchapi = await async_client.external.searchapi.google_search(
            q="q",
        )
        assert_matches_type(GoogleSearchResponse, searchapi, path=["response"])
    ...
    async def test_raw_response_google_search(self, async_client: AsyncStructify) -> None:
        response = await async_client.external.searchapi.with_raw_response.google_search(
            q="q",
        )
    ...
    async def test_streaming_response_google_search(self, async_client: AsyncStructify) -> None:
        async with async_client.external.searchapi.with_streaming_response.google_search(
            q="q",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_location_search(self, async_client: AsyncStructify) -> None:
        searchapi = await async_client.external.searchapi.location_search(
            q="q",
        )
        assert_matches_type(LocationResponse, searchapi, path=["response"])
    ...
    async def test_raw_response_location_search(self, async_client: AsyncStructify) -> None:
        response = await async_client.external.searchapi.with_raw_response.location_search(
            q="q",
        )
    ...
    async def test_streaming_response_location_search(self, async_client: AsyncStructify) -> None:
        async with async_client.external.searchapi.with_streaming_response.location_search(
            q="q",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
