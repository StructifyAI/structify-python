...
from structify.types.admin import UserListResponse, ImpersonateResponse
...
class TestUsers:
    ...
    @parametrize
    def test_method_impersonate(self, client: Structify) -> None:
        user = client.admin.users.impersonate(
            membership_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(ImpersonateResponse, user, path=["response"])

    @parametrize
    def test_raw_response_impersonate(self, client: Structify) -> None:
        response = client.admin.users.with_raw_response.impersonate(
            membership_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    @parametrize
    def test_streaming_response_impersonate(self, client: Structify) -> None:
        with client.admin.users.with_streaming_response.impersonate(
            membership_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncUsers:
    ...
    @parametrize
    async def test_method_impersonate(self, async_client: AsyncStructify) -> None:
        user = await async_client.admin.users.impersonate(
            membership_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(ImpersonateResponse, user, path=["response"])

    @parametrize
    async def test_raw_response_impersonate(self, async_client: AsyncStructify) -> None:
        response = await async_client.admin.users.with_raw_response.impersonate(
            membership_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    @parametrize
    async def test_streaming_response_impersonate(self, async_client: AsyncStructify) -> None:
        async with async_client.admin.users.with_streaming_response.impersonate(
            membership_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
