...
class TestSandbox:
    ...
    def test_method_list(self, client: Structify) -> None:
        ...
        assert_matches_type(SyncJobsList[AdminSandboxResponse], sandbox, path=["response"])
...
class TestAsyncSandbox:
    ...
    async def test_method_list(self, async_client: AsyncStructify) -> None:
        ...
        assert_matches_type(AsyncJobsList[AdminSandboxResponse], sandbox, path=["response"])
