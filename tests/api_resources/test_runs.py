...
from structify.types import JobNode, RunListResponse, ExecutionHistory
...
class TestRuns:
    ...
    def test_method_retrieve(self, client: Structify) -> None:
        ...
        assert_matches_type(ExecutionHistory, run, path=["response"])
    ...
    def test_method_cancel(self, client: Structify) -> None:
        ...
        assert_matches_type(JobNode, run, path=["response"])
