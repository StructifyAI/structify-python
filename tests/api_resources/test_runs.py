...
from structify.types import RunListResponse, RunCancelResponse, RunGetStepResponse, RunGetStepsResponse
...
class TestRuns:
    ...
    def test_method_get_step(self, client: Structify) -> None:
        ...
        assert_matches_type(RunGetStepResponse, run, path=["response"])
