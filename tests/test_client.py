...
from structify._exceptions import APITimeoutError, APIStatusError, StructifyError, APIResponseValidationError
...
from structify._models import FinalRequestOptions, BaseModel
from structify._types import NOT_GIVEN, Headers, NotGiven, Query, Body, Timeout, Omit
from structify._base_client import DEFAULT_TIMEOUT, HTTPX_DEFAULT_TIMEOUT, BaseClient, RequestOptions, make_request_options
from structify._streaming import Stream, AsyncStream
from structify._constants import RAW_RESPONSE_HEADER
from structify._response import APIResponse, AsyncAPIResponse
...
class TestStructify:
    ...
    def test_copy_default_headers(self) -> None:
        client = Structify(base_url=base_url, api_key=api_key, _strict_response_validation=True, default_headers={
            "X-Foo": "bar"
        })
    ...
    def test_copy_default_query(self) -> None:
        client = Structify(base_url=base_url, api_key=api_key, _strict_response_validation=True, default_query={
            "foo": "bar"
        })
    ...
    def test_client_timeout_option(self) -> None:
        client = Structify(base_url=base_url, api_key=api_key, _strict_response_validation=True, timeout=httpx.Timeout(0))
    ...
    def test_http_client_timeout_option(self) -> None:
        ...
        with httpx.Client(timeout=None) as http_client:
          client = Structify(base_url=base_url, api_key=api_key, _strict_response_validation=True, http_client=http_client)
    ...
    async def test_invalid_http_client(self) -> None:
        with pytest.raises(TypeError, match='Invalid `http_client` arg') :
            async with httpx.AsyncClient() as http_client :
                Structify(base_url=base_url, api_key=api_key, _strict_response_validation=True, http_client=cast(Any, http_client))
    ...
    def test_default_headers_option(self) -> None:
        ...
        client2 = Structify(base_url=base_url, api_key=api_key, _strict_response_validation=True, default_headers={
            "X-Foo": "stainless",
    ...
    def test_base_url_env(self) -> None:
        ...
        with update_env(STRUCTIFY_BASE_URL='http://localhost:5000/from/env'):
          ...
          client = Structify(base_url=None, api_key=api_key, _strict_response_validation=True, environment="production")
          assert str(client.base_url).startswith("https://api.structify.ai")

    @pytest.mark.parametrize("client", [Structify(base_url="http://localhost:5000/custom/path/", api_key=api_key, _strict_response_validation=True), Structify(base_url="http://localhost:5000/custom/path/", api_key=api_key, _strict_response_validation=True, http_client=httpx.Client())], ids = ["standard", "custom http client"])
    ...
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        ...
        with pytest.raises(APITimeoutError):
            self.client.get("/server/version", cast_to=httpx.Response, options={"headers": {RAW_RESPONSE_HEADER: "stream"}})
...
class TestAsyncStructify:
    ...
    def test_copy_default_headers(self) -> None:
        client = AsyncStructify(base_url=base_url, api_key=api_key, _strict_response_validation=True, default_headers={
            "X-Foo": "bar"
        })
        assert client.default_headers['X-Foo'] == 'bar'
    ...
    def test_copy_default_query(self) -> None:
        client = AsyncStructify(base_url=base_url, api_key=api_key, _strict_response_validation=True, default_query={
            "foo": "bar"
        })
        assert _get_params(client)['foo'] == 'bar'
    ...
    async def test_client_timeout_option(self) -> None:
        client = AsyncStructify(base_url=base_url, api_key=api_key, _strict_response_validation=True, timeout=httpx.Timeout(0))
    ...
    async def test_http_client_timeout_option(self) -> None:
        ...
        async with httpx.AsyncClient(timeout=None) as http_client:
          client = AsyncStructify(base_url=base_url, api_key=api_key, _strict_response_validation=True, http_client=http_client)
    ...
    def test_invalid_http_client(self) -> None:
        with pytest.raises(TypeError, match='Invalid `http_client` arg') :
            with httpx.Client() as http_client :
                AsyncStructify(base_url=base_url, api_key=api_key, _strict_response_validation=True, http_client=cast(Any, http_client))
    ...
    def test_default_headers_option(self) -> None:
        ...
        client2 = AsyncStructify(base_url=base_url, api_key=api_key, _strict_response_validation=True, default_headers={
            "X-Foo": "stainless",
            "X-Stainless-Lang": "my-overriding-header",
        })
        request = client2._build_request(FinalRequestOptions(method="get", url='/foo'))
    ...
    def test_base_url_setter(self) -> None:
        client = AsyncStructify(base_url="https://example.com/from_init", api_key=api_key, _strict_response_validation=True)
        assert client.base_url == "https://example.com/from_init/"
    ...
    def test_base_url_env(self) -> None:
        ...
        with update_env(STRUCTIFY_BASE_URL='http://localhost:5000/from/env'):
          ...
          client = AsyncStructify(base_url=None, api_key=api_key, _strict_response_validation=True, environment="production")
          assert str(client.base_url).startswith("https://api.structify.ai")

    @pytest.mark.parametrize("client", [AsyncStructify(base_url="http://localhost:5000/custom/path/", api_key=api_key, _strict_response_validation=True), AsyncStructify(base_url="http://localhost:5000/custom/path/", api_key=api_key, _strict_response_validation=True, http_client=httpx.AsyncClient())], ids = ["standard", "custom http client"])
    def test_base_url_trailing_slash(self, client: AsyncStructify) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    @pytest.mark.parametrize("client", [AsyncStructify(base_url="http://localhost:5000/custom/path/", api_key=api_key, _strict_response_validation=True), AsyncStructify(base_url="http://localhost:5000/custom/path/", api_key=api_key, _strict_response_validation=True, http_client=httpx.AsyncClient())], ids = ["standard", "custom http client"])
    def test_base_url_no_trailing_slash(self, client: AsyncStructify) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    @pytest.mark.parametrize("client", [AsyncStructify(base_url="http://localhost:5000/custom/path/", api_key=api_key, _strict_response_validation=True), AsyncStructify(base_url="http://localhost:5000/custom/path/", api_key=api_key, _strict_response_validation=True, http_client=httpx.AsyncClient())], ids = ["standard", "custom http client"])
    def test_absolute_request_url(self, client: AsyncStructify) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_client_max_retries_validation(self) -> None:
        with pytest.raises(TypeError, match=r"max_retries cannot be None"):
          AsyncStructify(base_url=base_url, api_key=api_key, _strict_response_validation=True, max_retries=cast(Any, None))
    ...
    async def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        ...
        with pytest.raises(APITimeoutError):
            await self.client.get("/server/version", cast_to=httpx.Response, options={"headers": {RAW_RESPONSE_HEADER: "stream"}})
