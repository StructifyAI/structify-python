...
pip install git+ssh://git@github.com/stainless-sdks/structify/structify-python.git
```
...
to add `STRUCTIFY_API_KEY="My API Key"` to your `.env` file
...
client.with_options(timeout=5 * 1000).server.version()
```
