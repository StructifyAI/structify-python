...
class DocumentsResourceWithRawResponse:
    def __init__(self, documents: DocumentsResource) -> None:
        ...
        self.delete_file_path = to_raw_response_wrapper(
            documents.delete_file_path,
        )
        self.download_file_id = to_raw_response_wrapper(
            documents.download_file_id,
        )
...
class AsyncDocumentsResourceWithRawResponse:
    def __init__(self, documents: AsyncDocumentsResource) -> None:
        ...
        self.delete_file_path = async_to_raw_response_wrapper(
            documents.delete_file_path,
        )
        self.download_file_id = async_to_raw_response_wrapper(
            documents.download_file_id,
        )
...
class DocumentsResourceWithStreamingResponse:
    def __init__(self, documents: DocumentsResource) -> None:
        ...
        self.delete_file_path = to_streamed_response_wrapper(
            documents.delete_file_path,
        )
        self.download_file_id = to_streamed_response_wrapper(
            documents.download_file_id,
        )
...
class AsyncDocumentsResourceWithStreamingResponse:
    def __init__(self, documents: AsyncDocumentsResource) -> None:
        ...
        self.delete_file_path = async_to_streamed_response_wrapper(
            documents.delete_file_path,
        )
        self.download_file_id = async_to_streamed_response_wrapper(
            documents.download_file_id,
        )
