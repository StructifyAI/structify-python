...
from .dataset_entity_ws_params import DatasetEntityWsParams as DatasetEntityWsParams
...
from .structure_job_status_ws_params import StructureJobStatusWsParams as StructureJobStatusWsParams
