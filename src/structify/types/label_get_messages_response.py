...
__all__ = [
    ...
    "ChatHumanLlmMetadataHistoryStepPromptMetadataExtractionCriterion",
    ...
    "ChatMetadataExtractionCriterion",
...
class ChatHumanLlmMetadataHistoryStepPromptMetadataExtractionCriterion(BaseModel):
...
class ChatHumanLlmMetadataHistoryStepPromptMetadata(BaseModel):
    ...
    extraction_criteria: List[ChatHumanLlmMetadataHistoryStepPromptMetadataExtractionCriterion]
...
class ChatMetadataExtractionCriterion(BaseModel):
    property_names: List[str]
...
class ChatMetadata(BaseModel):
    ...
    extraction_criteria: List[ChatMetadataExtractionCriterion]
