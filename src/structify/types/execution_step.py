...
__all__ = ["ExecutionStep", "Response", "ResponseToolCall", "ResponseToolCallInput", "ResponseToolCallInputSave", "ResponseToolCallInputScroll", "ResponseToolCallInputScrollScroll", "ResponseToolCallInputExit", "ResponseToolCallInputExitExit", "ResponseToolCallInputClick", "ResponseToolCallInputClickClick", "ResponseToolCallInputHover", "ResponseToolCallInputHoverHover", "ResponseToolCallInputWait", "ResponseToolCallInputWaitWait", "ResponseToolCallInputError", "ResponseToolCallInputErrorError", "ResponseToolCallInputGoogle", "ResponseToolCallInputGoogleGoogle", "ResponseToolCallInputType", "ResponseToolCallInputTypeType", "ResponseToolCallResult", "ResponseToolCallResultToolQueued", "ResponseToolCallResultToolFail", "ResponseToolCallResultInputParseFail", "ResponseToolCallResultSuccess"]
...
ResponseToolCallInput: TypeAlias = Union[ResponseToolCallInputSave, ResponseToolCallInputScroll, ResponseToolCallInputExit, ResponseToolCallInputClick, ResponseToolCallInputHover, ResponseToolCallInputWait, ResponseToolCallInputError, ResponseToolCallInputGoogle, ResponseToolCallInputType]
...
ResponseToolCallResult: TypeAlias = Union[ResponseToolCallResultToolQueued, ResponseToolCallResultToolFail, ResponseToolCallResultInputParseFail, ResponseToolCallResultSuccess, None]
