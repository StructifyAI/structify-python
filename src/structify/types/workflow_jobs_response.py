...
__all__ = ["WorkflowJobsResponse", "WorkflowJobsResponseItem"]


class WorkflowJobsResponseItem(BaseModel):
    id: str
...
WorkflowJobsResponse: TypeAlias = List[WorkflowJobsResponseItem]
