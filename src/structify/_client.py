...
class Structify(SyncAPIClient):
    ...
    source: resources.SourceResource
    ...
    def __init__(
        ...
        *,
        ...
        This automatically infers the `api_key` argument from the `STRUCTIFY_API_KEY` environment variable if it is not provided.
        """
        if api_key is None:
            api_key = os.environ.get("STRUCTIFY_API_KEY")
        if api_key is None:
            raise StructifyError(
                "The api_key client option must be set either by passing api_key to the client or by setting the STRUCTIFY_API_KEY environment variable"
            )
        ...
        self.source = resources.SourceResource(self)
...
class AsyncStructify(AsyncAPIClient):
    ...
    source: resources.AsyncSourceResource
    ...
    def __init__(
        ...
        *,
        ...
        self.source = resources.AsyncSourceResource(self)
...
class StructifyWithRawResponse:
    def __init__(self, client: Structify) -> None:
        ...
        self.source = resources.SourceResourceWithRawResponse(client.source)
...
class AsyncStructifyWithRawResponse:
    def __init__(self, client: AsyncStructify) -> None:
        ...
        self.source = resources.AsyncSourceResourceWithRawResponse(client.source)
...
class StructifyWithStreamedResponse:
    def __init__(self, client: Structify) -> None:
        ...
        self.source = resources.SourceResourceWithStreamingResponse(client.source)
...
class AsyncStructifyWithStreamedResponse:
    def __init__(self, client: AsyncStructify) -> None:
        ...
        self.source = resources.AsyncSourceResourceWithStreamingResponse(client.source)
